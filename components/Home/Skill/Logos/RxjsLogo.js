export default function RxjsLogo() {
  return (
    <svg
    ...
    >
      ...
      >
        ...
        <stop offset=".4" stopColor="#df1d85" />
      ...
      <radialGradient
        ...
        cx="190.46"
        cy="80.2"
        gradientTransform="matrix(1 .00239 -.002 .8362 .16 12.69)"
        gradientUnits="userSpaceOnUse"
        r="121.58"
      >
        <stop offset="0" stopColor="#e01d84" />
        <stop offset=".14" stopColor="#de1e85" />
        <stop offset=".28" stopColor="#d62085" />
        <stop offset=".43" stopColor="#c92386" />
        <stop offset=".59" stopColor="#b72786" />
        <stop offset=".74" stopColor="#9d2b87" />
        <stop offset=".89" stopColor="#7c2e88" />
        <stop offset="1" stopColor="#5d2f88" />
      </radialGradient>
      <linearGradient
        id="c"
      ...
      >
        <stop offset="0" stopColor="#e01d84" />
        <stop offset=".24" stopColor="#da1e85" />
        <stop offset=".66" stopColor="#c72085" />
        <stop offset="1" stopColor="#b52284" />
      </linearGradient>
      <path
        d="M29.6 175.3c-5.2-16.2-6.7-33.3-3.7-50.9 1.3-7.3 3.3-14.3 5.5-21.4 0 0 13.8-45.3 60.5-66 0 0 16.1-8.5 40.3-9.1 0 0-3.3-3.2-5.4-4.6-11.4-7.6-28.4-10.1-38.7.6-3.1 3.2-5.7 6.7-8.6 9.9-3.3 3.6-7.3 6.6-11.9 8.3-4 1.5-8 1.2-12.1 1.9-4.2.7-8.5 2.2-11.9 4.9-3.7 3-5.2 7-5.6 11.6-.4 3.6-.3 7.3-.5 10.9C37 82 33.6 85 26 90.9a30.9 30.9 0 00-7.9 9c-6 10.6 3.6 21.6 4.1 32.3.1 2.2-.1 4.4-.9 6.5-.8 2.3-2.4 3.8-3.7 5.7-1.8 2.5-3 5.5-2.5 8.6s2.1 6 3.6 8.7c2.9 4.8 6.5 9.1 10.3 13.2.2 0 .4.2.6.4"
        fill="#e32286"
      />
      <path
